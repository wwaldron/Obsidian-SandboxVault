...
| [[Calendar]] | Time oriented files (*e.g.*, [[318 - Friday, November 14, 2025\|daily notes]], meetings) |
...
| Dataview           | Enabled   | Javascript note organization                                              |
...
My templates are divided into two categories:

1. Triggers (for templates to be inserted in the current file *or* for those that need information about the current file which are often linked to Meta Bind buttons)
1. Templates (the structure of the file that is actually be created)
